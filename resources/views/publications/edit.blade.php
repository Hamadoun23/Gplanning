    ...
    <div class="publication-create-container" data-gsap="fadeIn">
        ...
        <div class="create-hero" data-gsap="fadeInUp">
            ...
            <div class="hero-content">
                <h1 class="hero-title">Modifier publication</h1>
                <p class="hero-subtitle">Modifiez les informations de cette publication</p>
            </div>
        </div>
        
        @if(!empty($warnings))
            <div class="alert-card alert-warning-modern" data-gsap="fadeInUp" data-alert>
                ...
                <div class="alert-content-modern">
                    ...
                    <p class="alert-note">Vous pouvez continuer malgré ces avertissements.</p>
                </div>
                <button type="button" class="alert-close-modern" onclick="this.parentElement.remove()" aria-label="Fermer">
        ...
        <div class="form-card-modern" data-gsap="fadeInUp">
            <form action="{{ route('publications.update', $publication) }}" method="POST" id="publication-form" class="publication-form-modern">
                ...
                @php
                    $month = request()->get('return_month', $publication->date ? $publication->date->month : now()->month);
                    $year = request()->get('return_year', $publication->date ? $publication->date->year : now()->year);
                @endphp
                ...
                <div class="form-actions-modern" data-gsap="fadeInUp">
                    <button type="submit" class="btn-primary-modern" id="submit-btn">
                        ...
                        <span class="btn-text">Modifier la publication</span>
                    </button>
                    <a href="{{ route('publications.index') }}" class="btn-secondary-modern">
                        <span class="btn-icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <line x1="18" y1="6" x2="6" y2="18"></line>
                                <line x1="6" y1="6" x2="18" y2="18"></line>
