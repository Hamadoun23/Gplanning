    ...
    <div class="publication-create-container" data-gsap="fadeIn">
        ...
        <div class="create-hero" data-gsap="fadeInUp">
            ...
            <div class="hero-content">
                <h1 class="hero-title">Nouvelle publication</h1>
                <p class="hero-subtitle">Créez une nouvelle publication pour votre planning</p>
            </div>
        </div>
            ...
            <form action="{{ route('publications.store') }}" method="POST" id="publication-form" class="publication-form-modern" autocomplete="one-time-code">
                ...
                <div class="form-actions-modern" data-gsap="fadeInUp">
                    <button type="submit" class="btn-primary-modern" id="submit-btn">
                        ...
                        <span class="btn-text">Créer la publication</span>
                    </button>
